...
public class Singleton implements Serializable, Cloneable {
	...
	/**
	 * @category Singleton Object volatile : changes done in object will be
	 *           reflected to all the threads
	 */
	private static volatile Singleton singleton;

	/**
	 * Constructor throw InstantiationError Exception in case some one initializing
